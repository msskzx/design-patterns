...
// DONE Part 1.3: implement Observer<Double>
public class GaugeGUI implements Observer<Double> {
	...
	// DONE Task 1.3: Implement: invoke setCurrentValue(..) with the Celsius value
	// of the subject (converted to int)
	// and then invoke repaint() on the gaugeCanvas
	@Override
	public void onUpdate(Double newState) {
		this.setCurrentValue(newState.intValue());
		this.gaugeCanvas.repaint();
	}
	...
	private class GaugeCanvas extends JPanel {
		...
		public void paint(Graphics graphics) {
			...
			graphics.fillOval(GRAPHICS_LEFT - GRAPHICS_WIDTH / 2, GRAPHICS_TOP + GRAPHICS_HEIGHT - GRAPHICS_WIDTH / 3,
					GRAPHICS_WIDTH * 2, GRAPHICS_WIDTH * 2);
			graphics.setColor(Color.black);
			graphics.drawOval(GRAPHICS_LEFT - GRAPHICS_WIDTH / 2, GRAPHICS_TOP + GRAPHICS_HEIGHT - GRAPHICS_WIDTH / 3,
					GRAPHICS_WIDTH * 2, GRAPHICS_WIDTH * 2);
