...
public final class TemperatureApplication {
	...
	// DONE Part 0: Before you start coding have a look at the project to create an
	// overview & understanding how it works.
	// DONE Part 2: Create a new class KelvinGUI as subclass of TemperatureGUI and
	// add it as observer to the TemperatureModel.
	...
	public static void main(String[] args) throws Exception {
		...
		// DONE Part 2: Instantiate the new KelvinGUI here and show it.
