 ...
 *      machine-specific ones transistor size, transistor type and gate type.
 */
public class TransistorControlRoomView extends ControlRoomView {
	...
	public void update(Machine currMachine) {
		 ...
		 * (current-temperature, current-voltage, transSize, transType\ and gateType)
		 * and provide them instead of the static dummy values
		 */
	...
	/**
	 * Add action listeners to the setTransistorSize the setTransistorType & the
	 * setGateType button in order to update the machine with the input values from
