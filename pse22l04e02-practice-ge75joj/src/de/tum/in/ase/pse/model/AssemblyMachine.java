...
/**
 * This class is representing a factory machine producing chips by assembling
 * transistors, which is a model inside the system.
 */
public class AssemblyMachine extends Machine {
	...
	public AssemblyMachine(String name, int minVoltage, int maxVoltage, int targetVoltage, int minTemperature,
			int maxTemperature, int targetTemperature, int spaceBetweenTrans, ChipType chipType) {
	...
	/**
	 * Standard setters for assembly machine values, that can be changed/updated
	 * after instantiation. Further the setters notify the machine's observers. 2.
	 * DONE: Think about the changes we made to the superclass's getters and setters
