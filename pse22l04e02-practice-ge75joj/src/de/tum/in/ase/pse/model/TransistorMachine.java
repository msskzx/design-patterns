...
/**
 * This class is representing a factory machine producing transistors, which is
 * a model inside the system.
 */
public class TransistorMachine extends Machine {
	...
	public TransistorMachine(String name, int minVoltage, int maxVoltage, int targetVoltage, int minTemperature,
			int maxTemperature, int targetTemperature, int transistorSize, TransistorType transistorType,
			GateType gateType) {
	...
	/**
	 * 2. DONE: Think about the changes we made to the superclass's getters and
	 * setters and update these accordingly Standard setters for transistor machine
	 * values, that can be changed/updated after instantiation. Further the setters
	 * notify the machine's observers.
	 */
