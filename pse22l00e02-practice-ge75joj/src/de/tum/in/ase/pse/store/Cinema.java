...
// DONE 4 remove all associations to the different controllers in all classes of the package store and use the facade
// instead.
public class Cinema {
	...
	public void deliverPopcorn(String shippingAddress) {
		...
		order.setShipping(eCommerceFacade.createShipping(shippingAddress));
		eCommerceFacade.shipOrder(order);
	}
