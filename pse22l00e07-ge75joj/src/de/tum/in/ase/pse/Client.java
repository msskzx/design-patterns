...
public final class Client {
	// DONE 1.1: Create a new class LinearSearch and implement the performSearch
	// method according to the problem statement on Artemis
	// DONE 1.2: Create a new class BinarySearch and implement the performSearch
	// method according to the problem statement on Artemis
	// DONE 2.1: Create a SearchStrategy interface according to the UML class
	// diagram and make the search algorithms implement this interface.
	// DONE 2.2: Create and implement a Context class according to the UML class
	// diagram
	// DONE 2.3: Create and implement a Policy class as described in the problem
	// statement
	...
	public static void main(String[] args) {
		// DONE 7: Init Context and Policy
		Context context = new Context();
		Policy policy = new Policy(context);

		// Run 10 times to simulate different search strategies
		for (int i = 0; i < NUMBER_OF_SIMULATIONS; i++) {
			// DOEN 8: Create a list of book entries using the method createRandomBook
			context.setBook(createRandomBook());
			// DONE 9: Configure Context
			policy.configure();

			String chapterToSearch = createChapters(1).get(0);
			// DONE 10: Search for chapter in book and store the result in pageNumber
	...
	/**
	 * Generates list of {@link Chapter} objects with random List size between 5 and
	 * 15. The list is with equal probability sorted or not.
	 */
