...
public class ServerConnectionHandler implements Runnable {
	...
	private ServerDispatcherCommunicationHandler serverDispatcher;
	...
	public void registerToDispatcher(String hostname, String ipAddress, int portNumber) {
		...
		serverDispatcher = new ServerDispatcherCommunicationHandler();
		serverDispatcher.register(hostname, ipAddress, portNumber);
	}
