...
public class ChatClient extends Application {
	...
	private final ClientDispatcherCommunicationHandler clientDispatcherCommunicationHandler = new ClientDispatcherCommunicationHandler();
	...
	private void connect(String serverName) {
		try {
			// DONE: Task 4 - Fetch server location from the client communication handler
