...
/**
 * DONE: 1. Add the correct interface
 **/
public class ForwardCommand implements Command {
	...
	/**
	 * DONE: 2. Implement the function defined from the interface The function
	 * should tell the drone to fly forward if the drone has started or print an
	 * error message, if the drone is still on the ground Hint: You can use the
	 * drone.flying flag to check whether the drone is in the air or not
	 */
	@Override
	public void execute() {
		if (drone.isFlying()) {
			...
			System.out.println("Drone has not started");
		}
