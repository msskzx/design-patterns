...
public final class Driver {
	...
	public static void main(String[] args) {
		...
		/*
		 * TODO: Task 5 0. Uncomment the Broker instance above. 1. Instantiate a
		 * dictionary client and a translation client 2. Set the broker for both clients
		 * 3. Instantiate a dictionary server and a translation server with their
		 * appropriate name provided as constants in the Broker class. 4. Set the broker
		 * for both servers 5. Call the servers from their respective clients
		 */
	}
}
